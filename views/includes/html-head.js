...
const HtmlHead = ({
  ...
  return (
    <Fragment>
      ...
      <link
        rel="stylesheet"
        href={`https://www.ft.com/__origami/service/build/v2/bundles/css?modules=o-normalise@^1.5.3,o-fonts@^3.0.4,o-grid@^4.3.7,o-typography@^5.4.2,o-header@^7.2.8,o-footer@^6.0.8,o-teaser@^2.2.2${flags.comments &&
          ',o-comments@^4.0.7'}${flags.shareButtons && ',o-share@^6.1.0'}${flags.ads &&
          ',o-ads@^8.0.0'}`}
      />
    ...
    }('https://www.ft.com/__origami/service/build/v2/bundles/js?modules=o-header@^7.2.8,o-footer@^6.0.8,o-date@^2.10.3,o-errors@^3.6.1,o-teaser@^2.2.2${flags.comments &&
      ',o-comments@^4.0.7'}${flags.shareButtons && ',o-share@^6.1.0'}${flags.analytics &&
            ',o-tracking@^1.2.3'}${flags.ads && ',o-ads@^8.0.0'}'));
    `,
        }}
      />
